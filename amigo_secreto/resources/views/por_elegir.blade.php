                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <div class="alert alert-primary" role="alert"
                                    ...
                                    <h5 class="card-text" style="color: #fff">FALTAN POR ELEGIR.
                                    </h5>
                                </div>
...
@endphp
                                            @foreach ($elegir as $elegi)
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    <td>{{ ucfirst(strtolower($elegi->nombre)) }}</td>
                                                    <td>{{ mb_strtoupper($elegi->pri_apellido) }}</td>
                                                    <td>{{ mb_strtoupper($elegi->seg_apellido) }}</td>
                                                    <td>{{ $elegi->age }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
