                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <div class="alert alert-primary" role="alert"
                                    ...
                                    <h5 class="card-text" style="color: #fff">LISTAR PAREJAS.
                                    </h5>
                                </div>
                                        ...
                                        <tbody>
                                                    ...
                                                    $i=1;
                                                     @endphp
                                                                ...
                                                                <tr>
                                                                <td>{{$i++}}</td>
                                                                <td>{{ucfirst(strtolower($amigo->fecha_reg))}}</td>
                                                                <td>{{ucfirst(strtolower($amigo->id_amigo))}}</td>
                                                                <td>{{ucfirst(strtolower($amigo->Amigo))}}</td>
                                                                <td>{{mb_strtoupper($amigo->N_amigo)}}</td>
                                                                <td>{{mb_strtoupper($amigo->Ag_amigo)}}</td>
                                                                <td>{{mb_strtoupper($amigo->id_user)}}</td>
                                                                <td>{{$amigo->Usuario}}</td>
                                                                <td>{{$amigo->N_user}}</td>
                                                                <td>{{$amigo->Ag_user}}</td>
                                                            </tr>
