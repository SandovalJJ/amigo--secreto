                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <div class="alert alert-primary" role="alert"
                                    ...
                                    <h5 class="card-text" style="color: #fff">FALTAN POR GIRAR.
                                    </h5>
                                </div>
...
$i=1;
 @endphp
                                            @foreach ($por_girar as $por_gira)
                                            <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$por_gira->cc_user}}</td>
                                            <td>{{ucfirst(strtolower($por_gira->name))}}</td>
                                            <td>{{mb_strtoupper($por_gira->p_apellido).' '. mb_strtoupper($por_gira->s_apellido)}}</td>
                                            <td>{{$por_gira->area}}</td>
                                        </tr>
@endforeach
